          ...
          <div className="content-box">
            <div className="content-box-header">
              ...
              <div className="content-box-btn">
                <a href="/situations/create" className="btn-success align-icon-btn">
            ...
            <div className="table-container mt-6">
              <table className="table">
                ...
                {situations.map((situation) => (
                  <tr className="table-row-body" key={situation.id}>
                    ...
                    <a href={`/situations/${situation.id}`} className="btn-primary flex items-center space-x-1">
                          ...
                          <a href={`/situations/${situation.id}/edit`} className="btn-warning hidden md:flex items-center space-x-1">
