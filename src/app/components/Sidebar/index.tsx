        ...
        <aside id="sidebar" className={`sidebar sm:translate-x-0 ${isOpen ? 'translate-x-0' : '-translate-x-full '}`}>
            <div className="sidebar-container">
                ...
                <div className="sidebar-header">
                    <span className="sidebar-title">Gasperoto</span>
                </div>
                <nav className="sidebar-nav">
                    ...
                    <a href="/situations/list" className="sidebar-link">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-5">
                    ...
                    <a href="/products/list" className="sidebar-link">
                    ...
                    <a href="/product-situations/list" className="sidebar-link">
                      ...
                      <span>Situações de Produtos</span>
                    </a>
