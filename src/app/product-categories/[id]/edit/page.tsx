        ...
        <div className="content-wrapper">
            <div className="content-header">
                ...
                <nav className="breadcrumb">
                    ...
                    <span> / </span>
                    <Link href="/product-categories/list" className="breadcrumb-link">Categorias de Produto</Link>
                    <span> / </span>
                    <span>Editar</span>
                </nav>
            </div>
        ...
        <div className="content-box">
            <div className="content-box-header">
                ...
                <div className="content-box-btn">
                    <a href="/product-categories/list" className="btn-info align-icon-btn">
                    ...
                    <a href={`/product-categories/${id}`} className="btn-primary align-icon-btn">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
                            stroke="currentColor" className="size-5">
                            <path strokeLinecap="round" strokeLinejoin="round"
